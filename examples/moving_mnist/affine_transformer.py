...
class Affine_Transformer():
    def __init__(self, frame_pixels, digit_pixels, device):
        ...
        self.scale_dtof = torch.FloatTensor([[self.frame_pixels / self.digit_pixels, 0], [0, self.frame_pixels / self.digit_pixels]]).to(device)
        self.scale_ftod = torch.FloatTensor([[self.digit_pixels / self.frame_pixels, 0], [0, self.digit_pixels / self.frame_pixels]]).to(device)
