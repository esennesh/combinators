...
class Train_APG(Trainer):
    def __init__(self, models, train_loader, num_epochs, device, exp_name, lr, sample_size, num_sweeps, resampler, mnist_mean):
    ...
    def train_epoch(self, epoch):
        ...
        for b, images in enumerate(self.train_loader):
...
def main(args):
    ...
    data_loader, _, _, _ = setup_data_loader(**dataset_args)
